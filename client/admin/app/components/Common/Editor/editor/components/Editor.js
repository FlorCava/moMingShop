...
class MyEditor extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.rawContentState && this.state.initFromRawContent === false) {
            this.setState({
                editorState: EditorState.createWithContent(convertFromRaw(JSON.parse(nextProps.rawContentState)), new CompositeDecorator([LinkDecorator])),
                initFromRawContent: true
            });
